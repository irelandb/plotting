...
rnap_real_raw = pd.read_csv('GFP_compneural_linfoot',delim_whitespace=True)
...
indices = [(not 'iterLS' in name and '130' in name) for name in rnap_real['fitting']]
...
plt.savefig('GFP_compneural_v2_2_linfoot.pdf')
plt.close()
